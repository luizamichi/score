/*! ApexCharts v3.26.0 | (c) 2018-2021 Juned Chhipa | apexcharts.com */
...
/*! svg.filter.js v2.0.2 | (c) 2016 Wout Fierens | github.com/wout/svg.filter.js */
...
/*! svg.draggable.js v2.2.2 | (c) 2016 Wout Fierens | github.com/svgdotjs/svg.draggable.js */
...
// AUTOMATIC RENDERING
var chartRender=$(".chart");chartRender.length&&chartRender.each(function(){var e=$(this).data("series").split(","),t=$(this).data("categories").split(",");new ApexCharts(this,{grid:{padding:{right:0,left:0}},series:[{name:"Você",data:e}],chart:{type:"bar",height:350,toolbar:{show:!1}},plotOptions:{bar:{columnWidth:"55%",distributed:!0}},legend:{show:!1},dataLabels:{enabled:!0},xaxis:{categories:t,labels:{style:{fontSize:"12px"}}}}).render()});
