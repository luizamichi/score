...
define("PAGE_STAGE", FORM_STAGES[8]);
...
$questions = third_step_form();
$r = third_step_response(get_user()["student"]);
...
?>
	...
	<div class="container grid-lg py-4">
		...
		<form action="<?=ACTION_NAME?>behavioral-assessment/third-step" class="form-horizontal" data-save="true" method="post">
