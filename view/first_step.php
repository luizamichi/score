...
define("PAGE_STAGE", FORM_STAGES[6]);
...
$questions = first_step_form();
$r = first_step_response(get_user()["student"]);
...
?>
	...
	<div class="container grid-lg py-4">
		...
		<form action="<?=ACTION_NAME?>behavioral-assessment/first-step" class="form-horizontal" data-save="true" method="post">
