...
define("PAGE_STAGE", FORM_STAGES[9]);
...
$questions = fourth_step_form();
$r = fourth_step_response(get_user()["student"]);
...
?>
	...
	<div class="container grid-lg py-4">
		...
		<form action="<?=ACTION_NAME?>behavioral-assessment/fourth-step" class="form-horizontal" data-save="true" method="post">
			...
			<div class="text-right">
				<input class="btn btn-green btn-lg" type="submit" value="Finalizar"/>
			</div>
		</form>
	</div>
